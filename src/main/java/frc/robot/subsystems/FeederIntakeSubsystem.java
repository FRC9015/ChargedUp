...
public class FeederIntakeSubsystem extends SubsystemBase {
    ...
    private FeederIntakeSubsystem() {
        feederIntakeMotor = new CANSparkMax(IntakeConstants.INTAKE_DRIVE_CAN_ID, MotorType.kBrushless);
        feederIntakeMotor.setSmartCurrentLimit(20, 30);
        feederIntake = PneumaticHubSubsystem.getDoubleSolenoid(IntakeConstants.OPEN_CLOSE_SOLENOID);
        forward = false;
    }
