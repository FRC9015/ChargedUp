...
public final class Constants {
    ...
    public static final class ArmConstants {
        ...
        // Arm Feedforward Constants TODO: TUNE THESE
        public static final double ROTATE_KS = 1; // static constant
        public static final double ROTATE_MIN_KG = 0; // kG when the telescope is fully retracted
        public static final double ROTATE_MAX_KG = 1; // kG when the telescope is fully extended
        public static final double ROTATE_KV = 1; // velocity constant
